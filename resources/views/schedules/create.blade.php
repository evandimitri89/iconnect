    ...
    <form action="{{ route('schedules.store') }}" method="POST">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="text" name="subject" placeholder="Enter subject..."
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2" required>
        </div>
      ...
      <div class="flex justify-end mt-6">
        <a href="{{ route('dashboard') }}"
          class="mr-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded-lg">
          Cancel
        </a>
